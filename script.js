...
function preview() {
  ...
  const text = code
    .replace(/\[HR\]\[\/HR\]/g, "────────────────────────")
    .replace(/\[CENTER\]|\[\/CENTER\]|\[RIGHT\]|\[\/RIGHT\]|\[B\]|\[\/B\]|\[U\]|\[\/U\]|\[SIZE=\d\]|\[\/SIZE\]/g, "")
    .replace(/\[TABLE\]|\[\/TABLE\]|\[TR\]|\[\/TR\]|\[TD\]|\[\/TD\]/g, " ")
    .replace(/\[QUOTE\]/g, "\n> ")
    .replace(/\[\/QUOTE\]/g, "\n")
    .replace(/\[\/?[\w=]+\]/g, "");

  content.innerHTML = `<div class="preview-box">${escapeHtml(text).replace(/\n/g, "<br>")}</div>`;
